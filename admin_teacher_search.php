...
<body>
    ...
    while($row = mysqli_fetch_array($result)) {
        ...
        echo "<td class='edit'><a href='admin_teacher_list_edit.php?act=edit&ID=$row[0]'>แก้ไข</a></td> ";
        echo "<td class='delete'><a href='admin_teacher_del_db.php?ID=$row[0]' onclick=\"return confirm('Do you want to delete this record? !!!')\">ลบ</a></td> ";
        echo "</tr>";
    }
    echo "</table>";
    mysqli_close($con);
