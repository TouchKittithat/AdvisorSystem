...
<body>
    ...
    <div class="container">
        <div class="search">
            <form class="form-label" name="search" action="admin_student_search.php" method="POST" enctype="multipart/form-data">
    ...
    $result = mysqli_query($con, $query);
        ...
        while($row = mysqli_fetch_array($result)) {
            ...
            echo "<td class='edit'><a href='admin_student_list_edit.php?act=edit&ID=$row[0]'> แก้ไข </a></td> ";
            echo "<td class='delete'><a href='admin_student_del_db.php?ID=$row[0]' onclick=\"return confirm('Do you want to delete this record? !!!')\"> ลบ </a></td> ";
            echo "</tr>";
        }
        echo "</table>";
        mysqli_close($con);
