    ...
    <div class="container">
        <header class="d-flex flex-wrap align-items-center justify-content-center justify-content-md-between py-3 mb-4 border-bottom">
          ...
          <ul class="nav col-12 col-md-auto mb-2 justify-content-center mb-md-0">
            <li><a href="teacher_home.php" class="nav-link px-2 link-secondary">หน้าหลัก</a></li>
            <li><a href="teacher_info.php" class="nav-link px-2">ข้อมูลส่วนตัว</a></li>
            <li><a href="teacher_student_list.php" class="nav-link px-2">ข้อมูลนักศึกษา</a></li>
