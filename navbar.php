    ...
    <div class="container">
        <header class="d-flex flex-wrap align-items-center justify-content-center justify-content-md-between py-3 mb-4 border-bottom">
          ...
          <ul class="nav col-12 col-md-auto mb-2 justify-content-center mb-md-0">
            <li><a href="student_home.php" class="nav-link px-2 link-secondary">หน้าหลัก</a></li>
            <li><a href="student_info.php" class="nav-link px-2">ข้อมูลส่วนตัว</a></li>
            <li><a href="student_course.php" class="nav-link px-2">รายวิชา</a></li>
            <li><a href="student_course_insert.php" class="nav-link px-2">เพิ่มรายวิชา</a></li>
          ...
          <div class="col-md-3 text-end">
            ...
            <!--<button type="button" class="btn btn-outline-success me-2" onclick="window.location.href='index.php'">ออกจากระบบ</button>-->
